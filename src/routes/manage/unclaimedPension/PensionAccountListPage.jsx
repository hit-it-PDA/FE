        ...
        <Sheet.Content>
          <div className="p-5">
            ...
            <div className="p-3 flex flex-col gap-2">
              <div className="flex">
                <div className="flex-1 flex justify-start">제도 유형</div>
                <div className="flex-1 flex justify-end">DC</div>
              </div>
              <div className="flex">
                <div className="flex-1 flex justify-start">산정 기준일</div>
                <div className="flex-1 flex justify-end">2024-06-17</div>
              </div>
              <div className="flex">
                <div className="flex-1 flex justify-start">관리점명</div>
                <div className="flex-1 flex justify-end">강남역점</div>
              </div>
              <div className="flex">
                <div className="flex-1 flex justify-start">
                  단체명(사용자명)
                </div>
                <div className="flex-1 flex justify-end">테라주식회사</div>
              </div>
              <div className="flex">
                <div className="flex-1 flex justify-start">성명</div>
                <div className="flex-1 flex justify-end">홍길동</div>
              </div>
              <div className="flex">
                <div className="flex-1 flex justify-start">사업장 상태</div>
                <div className="flex-1 flex justify-end">폐업확인</div>
              </div>
              <div className="flex">
                <div className="flex-1 flex justify-start">복수사업자 여부</div>
                <div className="flex-1 flex justify-end">개인</div>
              </div>
              <div className="flex">
                <div className="flex-1 flex justify-start">담당자 연락처</div>
                <div className="flex-1 flex justify-end">1588-5000</div>
              </div>
            </div>
